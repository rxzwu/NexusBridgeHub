# NexusBridge — документация (RU)

[![PyPI version](https://img.shields.io/pypi/v/nexusbridge)](https://pypi.org/project/nexusbridge/)
[![Python 3.11–3.14](https://img.shields.io/pypi/pyversions/nexusbridge?label=python)](https://pypi.org/project/nexusbridge/)
...
│ Telegram    │ ────────────────► │ NexusBridge  │ ◄───────────── │ Worker на ПК    │
...
```bash
export NEXUSBRIDGE_JWT_SECRET="твой_длинный_секрет_32plus"
...
```powershell
$env:NEXUSBRIDGE_JWT_SECRET = "твой_длинный_секрет_32plus"
nexusbridge-server --host 0.0.0.0 --port 8765
```
...
- Уровень логов: `NEXUSBRIDGE_LOG_LEVEL=DEBUG` (по умолчанию `INFO`)
